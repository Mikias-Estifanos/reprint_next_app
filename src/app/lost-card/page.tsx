...
export default function LostCardForm() {
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Lost Card Form</h2>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className={`w-full mt-1 p-2 border ${
              ...
              errors.uploadImage ? 'focus:ring-red-500' : 'focus:ring-indigo-500'
            }`}
            required
          />
